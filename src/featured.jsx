            ...
            <div className="featured" ref={ref}>
                <div className={`leftProj ${inView ? 'fade-in' : ''}`}>
                    ...
                    <h5>
                        ...
                        to manage tasks, set deadlines, and visualize their weekly focus. I designed
                        intuitive wireframes and high-fidelity prototypes, then brought the front end to
                        life with responsive, mobile-first layouts.
                    </h5>

                    <div className="learnBtn">
                        <Link to='https://www.github.com/561Aloha'><img src={arrow} alt="Learn More Arrow" /></Link>
                        <Link to='https://www.github.com/561Aloha'><h3>Learn more</h3></Link>
                    </div>
                </div>
